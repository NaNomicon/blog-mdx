...
The [2025 Google DORA Report](https://dora.dev/research/2025/dora-report "reference | Annual DevOps metrics — AI correlated with 91% longer reviews") correlated a 90% increase in AI adoption with a **91% increase in code review time** and a **154% increase in PR size**. The [Cortex 2026 Engineering Benchmark](https://www.cortex.io/report/engineering-in-the-age-of-ai-2026-benchmark-report "reference | Engineering metrics showing incidents per PR up 23.5% YoY") found incidents per pull request up 23.5% year over year, even as PR volume grew 20%.

More code. Larger PRs. Longer reviews. More incidents.

[Rémi Verschelde](https://www.theregister.com/2026/02/18/godot_maintainers_struggle_with_draining/ "mention | Godot maintainer on AI PRs being draining and demoralizing"), a maintainer of the [Godot](https://godotengine.org/ "mention | Open-source game engine hit hard by AI PR spam") game engine, called the flood of AI-generated PRs *"draining and demoralizing"* a few weeks ago. [GitHub](https://github.com/ "mention | Platform hosting both Copilot and the PR flood discussion") - the company that ships [Copilot](https://github.com/features/copilot "mention | GitHub's AI coding assistant") - opened a [community thread](https://github.com/orgs/community/discussions/185387 "reference | GitHub's Feb 2026 discussion on low-quality AI contributions") in February 2026 about the rising volume of low-quality contributions, and started [discussing](https://www.theregister.com/2026/02/03/github_kill_switch_pull_requests_ai/ "reference | Register coverage of GitHub's proposed PR kill switch") what amounts to a kill switch for pull requests on repos.

The platform that built the generation tool is now building escape hatches from it.

[Daniel Stenberg](https://daniel.haxx.se/blog/2025/07/14/death-by-a-thousand-slops/ "mention | curl creator on AI slop flooding his bug bounty program"), creator of [curl](https://curl.se/ "reference | Widely-used command-line tool for URL data transfer"), watched AI-generated submissions consume 20% of all vulnerability reports to curl's bug bounty program in 2025. Only 5% described real vulnerabilities. He called it "Death by a Thousand Slops" and ended the bug bounty entirely.
...
As [Flamehaven](https://flamehaven.substack.com/p/the-pull-request-illusion-how-ai "reference | Essay arguing AI PRs decouple understanding from code changes") put it: "understanding stopped traveling with code."
...
[AGENTS.md](https://agents.md "reference | Convention for telling AI agents how to interact with a repo") is a good start - it tells agents how to interact with a repo. [ADRs](https://github.com/joelparkerhenderson/architecture-decision-record "reference | Templates for recording architectural decisions and rationale") capture architectural decisions. But neither captures the *negative space*: what a project deliberately chose not to become. The approach that was rejected. The scope boundary held against pressure. The tradeoff that made sense three years ago in a context nobody wrote down.
...
Partly true. The floor is liability, not craft. [AWS](https://aws.amazon.com/ "aside | Case in point — terrible docs, dominant market position") has had genuinely terrible documentation for over a decade. Still prints money. Switching cost is the moat. Quality only needs to clear the bar of "doesn't cause an expensive failure."
...
The [Potemkin](https://en.wikipedia.org/wiki/Potemkin_village "reference | Fake village facades — metaphor for superficially healthy codebases") codebases don't exist at scale yet.
