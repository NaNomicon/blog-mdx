export const metadata = {
    ...
    description: "In which I learned that client requirements and obfuscated code make for a dangerous combination",
    category: "TIL",
    cover_image: "/250527-the-hidden-buttons-that-must-never-die/cover.png",
};

<img src={metadata.cover_image} alt="cover image: The Hidden Buttons That Must Never Die"/>

*In which I learned that client requirements and obfuscated code make for a dangerous combination*
