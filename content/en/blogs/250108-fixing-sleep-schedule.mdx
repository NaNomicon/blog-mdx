export const metadata = {
    ...
    tldr: "Don't miss your sleeping window, take free time during the day so that your brain can process your emotion, do some work, do some exercise, eat fully, manage your stress, and try to wake up early and at the same time every day.",
};
