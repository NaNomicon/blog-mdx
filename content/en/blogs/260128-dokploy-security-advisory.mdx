...
👋 Hey! I noticed your Dokploy installation doesn't have
   secure credentials configured yet.

📝 I'll set up unique, secure credentials for your database
   automatically. This will only take a few seconds.

🔐 Generating secure credentials...
[REDACTED]]
✅ Credentials saved securely in Docker Secrets (encrypted)
🔄 Updating database...
ALTER ROLE
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
✅ All done! Your database is now secured with unique credentials.
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

📋 What was configured:
   • Unique secure password generated
   • Password stored in Docker Secrets (encrypted, in-memory only)
   • PostgreSQL service updated to use secrets
   • Dokploy service updated to use secrets

💡 Security features:
   • Password stored encrypted in Docker Swarm
   • Mounted in memory (tmpfs) - not accessible via bind mounts
   • Only accessible by authorized services
   • Cannot be read by user containers

💡 Next steps:
   • Your Dokploy should be accessible shortly
   • No action needed - everything is configured automatically
```
